...
public class ClientState extends BaseShellState<ClientState> {
    ...
    public void cleanup() {
        try {
            ...
            Log.log(ClientState.class, exc, "Exception occurred on cleanup");
        }
    }

    @Override
    public void prepareToExit(int exitCode) throws ExitRequest {
        Log.log(ClientState.class, "Preparing to exit with code:" + exitCode);
        cleanup();
        throw new ExitRequest(exitCode);
    }

    @Override
    public Map<String, Command<ClientState>> getCommands() {
