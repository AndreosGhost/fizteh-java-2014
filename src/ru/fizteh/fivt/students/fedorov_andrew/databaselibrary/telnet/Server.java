...
public class Server implements Closeable {
    ...
    private final Supplier<ShellState> shellStateSupplier;
    private ServerSocket serverSocket;
    private boolean deletingFromUsers = false;

    public Server(PrintStream reportStream, Supplier<ShellState> shellStateSupplier) {
    ...
    private void run() {
        try {
            ...
            try {
                ...
                Log.log(ServerState.class, exc, this + ": failed to close server socket");
            }
        }
    }
